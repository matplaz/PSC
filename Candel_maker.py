...
def candel(x):#x:sélection de la chandelle [24,4,15,1]
    ...
    chandelles=pd.DataFrame(columns=['V','Pmin','PQ1','Pmed','PQ3','Pmax','return']) # V:volume echange , Pmin,PQ1,Pmed,PQ3,Pmax:min, premier quartile, médiane, troisième quartile, max des prix des échanges d'ordre 'market', 'return':(P_close-P_open)/P_open
